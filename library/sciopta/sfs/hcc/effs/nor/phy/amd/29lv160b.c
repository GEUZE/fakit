...
/*  The following assumes 35 logical blocks in the sizes  */
/* 	Size	logical number	relative physical address	usage	 */
/* 	16k	0		0				free/not used		 */
/* 	8k	1		0x004000			descriptor	 */
/* 	8k	2		0x006000			descriptor	 */
/* 	32k	3		0x008000			free/not used	 */
/* 	64k	4		0x040000			file storage	 */
/* 	64k	5		0x050000			file storage	 */
/* 	..	.		........			file storage	 */
/* 	..	.		........			file storage	 */
/* 	64k	33		0x1e0000			file storage	 */
/* 	64k	34		0x1f0000			file storage	 */


#define BLOCKSIZE	0x10000			/*  64k - size of file storage blocks  */
#define BLOCKSTART	4			/*  logical number of first file storage block  */
#define MAXBLOCKS	31			/*  number of logical blocks for file storage  */

#define DESCSIZE	8192			/*  descriptor blocks in 8K physical blocks  */
...
#define SECTORSIZE	2048			/* 2k - sector size */
...
{
    if (block == 0) return 0;		/*  16k  */
    if (block == 1) return 0x4000;	/*  8k  */
    if (block == 2) return 0x6000;	/*  8k   */
    if (block == 3) return 0x8000;	/*  32k  */

    return	(BLOCKSIZE*(block-4+1))+(relsector*SECTORSIZE);	/*  others are 64k  */
}
...
int fs_phy_nor_29lv160b(FS_FLASH *flash) {
...
unsigned short dev_ID;
   ...
   if (man_ID==_x01 && dev_ID==_x2249) {		/*  29lv160b  */
