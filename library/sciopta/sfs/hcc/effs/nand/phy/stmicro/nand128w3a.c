#ifndef _nand128w3a_C_
#define _nand128w3a_C_
...
static int WritePage(void *data, long pagenum, long size,long sdata) 
{
	...
	NANDDATAL = sdata; /* add signature data into spare 3rd word */
...
int fs_phy_nand_nand128w3a(FS_FLASH *flash) 
{
	long manID, devID;
