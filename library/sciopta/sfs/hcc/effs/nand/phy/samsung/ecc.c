...
static void trans_result (unsigned char,unsigned char,unsigned char *,unsigned char *);
static void calculate_ecc (unsigned char *,unsigned char *,unsigned char *,unsigned char *,unsigned char *);
static unsigned char correct_data (unsigned char *,unsigned char *,unsigned char,unsigned char,unsigned char);
...
int _CorrectSwECC(unsigned char *,unsigned char *,unsigned char *);
void _CalculateSwECC(unsigned char *,unsigned char *);

/****************************************************************************/

int _CorrectSwECC(unsigned char *buf,unsigned char *redundant_ecc,unsigned char *calculated_ecc)
{
	unsigned int err;

	err=correct_data(buf,redundant_ecc,*(calculated_ecc+1),*(calculated_ecc),*(calculated_ecc+2));
	if(err==1) {
		calculated_ecc[0]=redundant_ecc[0];
		calculated_ecc[1]=redundant_ecc[1];
		calculated_ecc[2]=redundant_ecc[2];
	}
...
void _CalculateSwECC(unsigned char *buf,unsigned char *ecc)
{
