#ifndef _K9F2816X0C_16bit_old_ecc_C_
#define _K9F2816X0C_16bit_old_ecc_C_
...
static int WriteVerifyPage(void *data, long block, long startpage, long pagenum, long sdata) 
{
	...
	for (a=0; a<pagenum; a++) 
	{
		...
		readsign=NANDDATA & 0xffff;
		readsign<<=16;
		readsign|=NANDDATA & 0xffff;  /* 2times 16bit */
...
/****************************************************************************
 *
 *  end of K9F2816X0C_16bit_old_ecc.c
 *
 ***************************************************************************/

#endif /* _K9F2816X0C_16bit_old_ecc_C_ */
