#ifndef _K9F2816X0C_16bit_no_ecc_C_
#define _K9F2816X0C_16bit_no_ecc_C_
...
static int ReadPage(unsigned char *dest,long pagenum,unsigned long *psignature) 
{
	...
	/* read for temporaly (ECC is here)*/
	sigdata=(unsigned short)NANDDATA;
	sigdata=(unsigned short)NANDDATA;
...
/****************************************************************************
 *
 *  end of K9F2816X0C_16bit_no_ecc.c
 *
 ***************************************************************************/

#endif /* _K9F2816X0C_16bit_no_ecc_C_ */
