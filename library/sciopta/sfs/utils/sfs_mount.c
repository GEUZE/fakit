...
** Mount a directory on an other directory 
**********************************************************************
EOC*/
...
int
sfs_mount (sdd_obj_t NEARPTR  self, sdd_obj_t NEARPTR  NEARPTR   dir)
{
  sc_msg_t msg;
  static const sc_msgid_t sel[3] = {
    SDD_ERROR, SFS_MOUNT_REPLY, 0
  };

  (*dir)->base.id = SFS_MOUNT;
  (*dir)->manager = self->base.handle;
  sc_msgTx ((sc_msgptr_t ) dir, self->controller, 0);
...
/*
 * $Log: sfs_mount.c,v $
 * Revision 1.4  2008/02/14 14:15:49  bastian
 * merge from 1921
 *
 * Revision 1.3.14.1  2008/02/04 10:55:58  bastian
 * fix ups (filesystem)
 *
