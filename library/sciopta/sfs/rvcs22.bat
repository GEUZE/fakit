...
set INC=-I. -J%SCIOPTA_HOME%\include -I%SCIOPTA_HOME%\include\sciopta\arm -J"%RVCT22INC%" -I%SCIOPTA_HOME%\include\hcc
...
%AR% %ARFLAGS% ..\lib\arm\arm\rvct22\%LIB% version_sfs.o
