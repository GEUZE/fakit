...
#define IPS_CNF_LINK_LOGD_LEVEL                LODG_ALL

/*
 * ipv4
 */
#define IPS_CNF_IPV4_PKT_CACHE_SIZE            4 /* 1 .. 16  */
#define IPS_CNF_IPV4_FRAG_ENABLED              1 /* 0 | 1    */
...
#define IPS_CNF_IPV4_ARP_CACHE_SIZE            4 /* 1 .. 16  */
...
#define IPS_CNF_IPV4_STAT_ENABLED              1 /* 0 | 1    */
#define IPS_CNF_IPV4_RAW_ENABLED               1 /* 0 | 1    */

#define IPS_CNF_IPV4_LOGD_ENABLED              0
#define IPS_CNF_IPV4_LOGD_LEVEL                LODG_ALL

/*
 * icmp
 */
#define IPS_CNF_ICMP_TMO SC_FATAL_IF_TMO
#define IPS_CNF_ICMP_STAT_ENABLED               1 /* 0 | 1    */
#define IPS_CNF_ICMP_DEV_ENABLED                1 /* 0 | 1    */

#define IPS_CNF_ICMP_LOGD_ENABLED               0
#define IPS_CNF_ICMP_LOGD_LEVEL                 LODG_ALL
...
#define IPS_CNF_UDP_SOCKET_ENUM                 1 /* 0 | 1    */
#define IPS_CNF_UDP_STAT_ENABLED                1 /* 0 | 1    */

#define IPS_CNF_UDP_LOGD_ENABLED                0 /* 0 | 1    */
#define IPS_CNF_UDP_LOGD_LEVEL                  LODG_ALL
...
#define IPS_CNF_TCP_STAT_ENABLED                1 /* 0 | 1    */
#define IPS_CNF_TCP_SOCKET_ENUM                 1 /* 0 | 1    */

#define IPS_CNF_TCP_LOGD_ENABLED                0 /* 0 | 1    */
#define IPS_CNF_TCP_LOGD_LEVEL                  LODG_ALL
...
#define IPS_CNF_PPP_LOGD_LEVEL                  LODG_ALL
