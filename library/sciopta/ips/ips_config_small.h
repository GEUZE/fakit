...
** ID: S04029BS1                                                    **
** +Revision: 1.9 +                                                 **
** +Date: 2008/02/19 13:18:21 +                                     **
** Global minimal IPS configuration                                 **
**********************************************************************
** This file contains configuration options for all parts of IPS.
** If you like to use it add
** -DIPS_CONF="ips_config_small.h"
** to CFLAGS before compiling IPS
**
EOC*/
 ...
 * link
 */
#define IPS_CNF_LINK_RAW_ENABLED               0
 ...
 * ipv4
 */
#define IPS_CNF_IPV4_PKT_CACHE_SIZE            2 /* 1 .. 16  */
...
#define IPS_CNF_IPV4_ARP_DEV_ENABLED           0 /* 0 | 1    */
#define IPS_CNF_IPV4_ARP_CACHE_SIZE            2 /* 1 .. 16  */
#define IPS_CNF_IPV4_ARP_MAX_PROBES            2 /* 1 .. 255 */
#define IPS_CNF_IPV4_ROUTER_ENABLED            0 /* 0 | 1    */
#define IPS_CNF_IPV4_ROUTER_DEV_ENABLED        0 /* 0 | 1    */
#define IPS_CNF_IPV4_ROUTER_ROUTE_GET_ENABLED  0 /* 0 | 1    */
#define IPS_CNF_IPV4_ROUTER_ROUTE_WAIT_ENABLED 0 /* 0 | 1    */
...
#define IPS_CNF_ICMP_DEV_ENABLED               0 /* 0 | 1    */
...
#define IPS_CNF_TCP_MULTIPLE_POOLS              0 /* 0 | 1    */
#define IPS_CNF_TCP_ALG_CORK                    1  /* 0 | 1    */
#define IPS_CNF_TCP_ALG_PIGGYPACK               0 /* 0 | 1    */
#define IPS_CNF_TCP_ALG_NAGLE                   0 /* 0 | 1    */
...
#define IPS_CNF_DNS_MAX_ANSWERS                 10
#define IPS_CNF_DNS_NO_DBENTRIES                3 

/*
 * vpn
 */
#define IPS_CNF_VPN_CRYPTO_ENABLED              0

/*
** PPP
*/
#define IPS_CNF_PPP_LOGD_ENABLED                0
#define IPS_CNF_PPP_LOGD_LEVEL                  LOGD_ALL

/*
 * Stream
 */
#define IPS_CNF_BUF_SIZE                 	128 /* 1 ..              */
