...
#define __FUNC(a) ((__u32)a<<24)
#define __ERR(a)  ((__u32)a<<12) 
#define __CLASS(a) ((__u32)a)
#else
...
*/
#define SC_ERR_TARGET_FATAL     0x01
/*
...
#define SC_ERR_FATAL (SC_ERR_PROCESS_FATAL|SC_ERR_MODULE_FATAL|SC_ERR_TARGET_FATAL)
#define SC_ERR_TARGET_WARNING   0x10
#define SC_ERR_MODULE_WARNING   0x20
#define SC_ERR_PROC_WARNING     0x40
...
****************************************************************************
** $Log: err.h,v $
** Revision 1.5  2008/01/16 13:02:02  bastian
** merge from 1.9.1.12
**
** Revision 1.4.12.1  2007/10/04 15:41:11  bastian
** fixes
**
** Revision 1.4  2004/01/08 13:53:27  bastian
** added sc_procPathCheck
** removed module defines
**
** Revision 1.3  2003/12/16 12:02:55  bastian
** added procPathGet
**
** Revision 1.2  2003/06/10 06:55:26  bastian
** need to differ between asm/c
**
