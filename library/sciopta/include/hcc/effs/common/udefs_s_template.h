...
#define FS_MAXVOLUME	1	/* maximum number of volumes */
#define FS_MAXTASK	2	/* maximum number of task */
...
#define FS_MUTEX_TYPE sc_pid_t /* mutex type for locking mechanism */
