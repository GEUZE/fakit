...
** Stack macros
*/
STATIC_INLINE __u32 currStackPtr(sc_pcb_t *pcb)
{
  __u32 sp = (__u32)pcb->stackptr;
  
  return sp ? sp : *(__u32 *)(pcb->stacktop-8);
}
...
#define DRUID_PROC_STACKTOP(module, process) \
  ((__u32 ) ((sc_pcb_t *) DRUID_PROC_CB (module, process))->stacktop+8)
  
#define DRUID_PROC_STACKPTR(module, process) \
   currStackPtr((sc_pcb_t *) DRUID_PROC_CB (module, process))
