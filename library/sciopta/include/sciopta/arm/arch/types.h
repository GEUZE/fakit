...
#define __PACKED _Pragma("pack(1)")
#define PACKED__
...
#ifdef __TKERNEL__
#define SC_TMO_MAX       ((sc_ticks_t)255)
#else
...
#ifdef __TKERNEL__
typedef __u8 sc_pid_t;
#define SC_PID_MAX       15
#define SC_ILLEGAL_PID   0x7f
#define SC_CURRENT_PID   ((sc_pid_t)0xff)
#else /* __TKERNEL__ */
...
#define SC_PID_MAX       0x0000000f
#define SC_PID_MSK       0x0000000f
#define SC_ILLEGAL_PID   0x0000007f
#define SC_CURRENT_PID   0x000000ff
#else /* __TKERNEL__ */
