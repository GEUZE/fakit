...
#define RAMDRV0_SIZE 0x100000          /* defintion for size of ramdrive0 */
#define RAMDRV1_SIZE 0x20000          /* defintion for size of ramdrive1 */
//#define RAMDRV1_SIZE 0x2100000          /* defintion for size of ramdrive1 */
...
static t_RamDrv RamDrv[RAMDRV_CNT] = {
  ...
  { ramdrv1, (RAMDRV1_SIZE/F_DEF_SECTOR_SIZE), 0, &t_drivers[1] },
};
...
F_DRIVER *f_ramdrvinit(unsigned long driver_param)
{
   t_RamDrv *p;
   unsigned int i;
