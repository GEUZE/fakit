...
#define PAGE2SECTOR(pg)    (((pg) < 8u) ? 0 : (((pg) < 256u) ? 1u : (((pg)>>8)+1u)))
...
#define SECTOR2PAGE(sc)    (((sc) < 1u) ? 0 : (((sc) < 2u) ? 8u : (((sc)-1u) << 8)))

#elif defined AT45DB21B     /****************************************************************** 2 Mbit chip */
#define ADF_ID		         (0x05u << 2)
#define PAGE2SECTOR(pg)    (((pg) < 8u) ? 0 : (((pg) < 256u) ? 1u : (((pg) < 512u) ? 2u : ((pg)>>9)+2u)))
#define SECTORSIZE(sc)     ((sc) < 1u ? 8u : ((sc) < 2u ? (256u-8u) : (((sc) < 3u) ? 256 : ADF_PAGES_PER_SECTOR)))
#define SECTOR2PAGE(sc)    (((sc) < 1u) ? 0 : ((sc) < 2u ? 8u : (((sc) < 3u) ? 256 : ((((sc)-2u) << 9)))))

#elif defined AT45DB41B     /****************************************************************** 4 Mbit chip */
#define ADF_ID		         (0x7u << 2)
#define PAGE2SECTOR(pg)    (((pg) < 8u) ? 0 : (((pg) < 256u) ? 1u : (((pg) < 512) ? 2u : ((pg)>>9)+2u)))
#define SECTORSIZE(sc)     ((sc) < 1u ? 8u : ((sc) < 2u ? (256u-8u) : (((sc) < 3u) ? 256 : ADF_PAGES_PER_SECTOR)))
#define SECTOR2PAGE(sc)    (((sc) < 1u) ? 0 : ((sc) < 2u ? 8u : (((sc) < 3u) ? 256 : ((((sc)-2u) << 9)))))
...
#define SECTOR2PAGE(sc)    (((sc) < 1u) ? 0 : ((sc) < 2u ? 8u : (((sc) < 3u) ? 256u : ((((sc)-2u) << 9)))))
...
#define PAGE2SECTOR(pg)    (((pg) < 8u) ? 0 : (((pg) < 512u) ? 1u : (((pg)>>9)+1u)))
#define SECTORSIZE(sc)     ((sc) < 1u ? 8u : ((sc) < 2u ? (512u-8u) : ADF_PAGES_PER_SECTOR))
#define SECTOR2PAGE(sc)    (((sc) < 1u) ? 0 : ((sc) < 2u ? 8u : (((sc)-1u) << 9)))
...
static int adf_getphy(F_DRIVER *driver, F_PHY *phy)
{
	...
	phy->sector_per_track = ADF_SECTOR_PER_TRACK;
	phy->number_of_heads = ADF_HEADS;
	phy->number_of_sectors = ADF_SECTORS;
...
F_DRIVER *f_dfdrvinit(unsigned long driver_param)
{

	(void)memset(&df_driver,0,sizeof(df_driver));

	df_driver.readsector=adf_read_sector;
   	df_driver.writesector=adf_write_sector;
   	df_driver.getphy=adf_getphy;
   	df_driver.getstatus=adf_getstatus;
