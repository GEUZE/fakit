 ...
 *
 *****************************************************************************/
#define HDD_BASE0  0x1000000

#ifdef HCC_HW

#define HDD_CSAR (*(volatile unsigned long *)(0xffc00050))   /* HDD's Chip Select Base regiter */
#define HDD_CSOR (*(volatile unsigned long *)(0xffc00054))   /* HDD's Chip Select Option regiter */
