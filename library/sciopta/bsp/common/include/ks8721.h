...
#define phy_init ks8721_init
int ks8721_checkLink(int fec_ch, int phy_addr);
#define phy_checkLink ks8721_checkLink


#define MII_10BASE_T        0
#define MII_100BASE_TX      1

/* MII Duplex Settings */
#define MII_HALF_DUPLEX     0
#define MII_FULL_DUPLEX     1
