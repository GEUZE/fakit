...
** ID: S09156BS3                                                    **
** +Revision: 1.1.2.1 +                                                 **
** +Date: 2009/08/20 09:01:58 +                                     **
** USBD:Standard protocol processing functions prototypes           **
**********************************************************************
EOC*/
...
typedef const struct _DEVICE_PROP
{
...
typedef const struct _USER_STANDARD_REQUESTS
{
