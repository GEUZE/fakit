/**
 * This file is altered by me (Tiddo) to include support for the 32md sdram on the
 *  lpc4088 oem board.
 *
 * Changes are:
 * -	- Heap is allocated in the ext_ram section (see linker file)
 *  	- sdram_init is called on heap initialization. 
 *
 * @author Tiddo Langerak<Tiddo Langerak>
 */
...
static unsigned char ucHeap[ configTOTAL_HEAP_SIZE ] __attribute__ ((section(".ext_ram")));
